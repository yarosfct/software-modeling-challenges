...
Research on domain diversity and motivation in modelling education reports that educators' assumptions about ``motivating'' domains do not always match students' preferences, and that students value domains that connect to their interests and everyday or socially relevant contexts \cite{anonDomainDiversityModeling2025}. The work also highlights that assignment design can unintentionally exclude learners when domains or examples presume cultural, economic, or experiential background that not all students share \cite{anonDomainDiversityModeling2025}. These findings motivate treating domain choice and inclusiveness as relevant contextual variables when interpreting modelling learning experiences.
