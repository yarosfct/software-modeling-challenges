...
Data collection consists primarily of semi-structured interviews, complemented by an activity-centered elicitation component anchored in concrete modelling tasks or artefacts. This combination is intended to elicit both reflective accounts and situated examples of modelling practice, following the logic used in prior modelling education research \cite{istar-learning}. The procedure was refined through a pilot to validate the interview flow, estimate duration (20--30 minutes), and improve probing for concrete examples.
...
At the time of writing, the survey component has not been finalised. If included, surveys will be used as a complementary data source to characterise the prevalence or distribution of selected themes emerging from interviews (e.g., commonly reported challenges or tool-related frustrations) and to support sampling for variation. Survey design, sampling, and analysis procedures will be specified once the survey instrument and its role in the overall design are stabilised.
...
To ensure rigour, the study follows established guidance for conducting grounded theory in software engineering and adopts a socio-technical stance consistent with STGT. Trustworthiness is addressed through practices that support credibility, dependability, confirmability, and transferability.
