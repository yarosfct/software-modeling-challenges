...
Software systems are complex socio-technical constructs that must satisfy functional and non-functional requirements while evolving under technical, organisational, and human constraints. Within this context, software modelling supports reasoning about software systems by providing abstractions that capture relevant aspects of a domain or system at an appropriate level of detail. Models can serve multiple roles: they may act as design blueprints, facilitate communication among stakeholders, and enable analysis and validation of properties before implementation \cite{maslov2021conceptual,buchmann2020conceptual}.
...
Several authors emphasise that a modelling method is more than a set of symbols or a notation. A modelling method can be understood as comprising a modelling language (including syntax, semantics, and notation), a modelling procedure (the process or steps to create models), and supporting mechanisms and algorithms such as analysis, simulation, or transformation capabilities \cite{bork2020framework,buchmann2020conceptual}. This holistic view clarifies why students may be able to reproduce diagrammatic symbols yet still struggle to apply modelling meaningfully: the procedural and analytical aspects of modelling are often less explicitly taught or assessed.
...
Conceptual and software modelling are widely taught across computing and software-related programmes, but the way these topics are taught and integrated into curricula remains fragmented. Maslov et al.\ \cite{maslov2021conceptual} map the conceptual modelling education literature and show that educational work is scattered across various modelling sub-communities (e.g., data modelling, process modelling, enterprise modelling, etc.), which often evolve in parallel with limited reuse of frameworks, terminology, and learning theories across subfields \cite{maslov2021conceptual}. Within this landscape, modelling appears in diverse course contexts (from introductory programming courses to advanced software engineering), and courses emphasise different modelling families and purposes (e.g., data-centric, process-centric, goal-oriented, etc.).
...
These frameworks are particularly useful for structuring interview and survey questions because they translate modelling competence into observable tasks.
...
Modelling in educational settings is often mediated by tools, ranging from simple drawing tools and web-based modellers to industrial-grade model-driven engineering (MDE) environments. Tool choice can influence students' perceptions of modelling and their opportunities to practice particular skills. Liebel et al.\ conducted a multi-case study of model-driven software engineering courses that use different tools (e.g., Umple, Papyrus) and place different emphasis on model-driven architecture and code generation \cite{liebel2014model}. Their results indicate that students' perceptions of tools are highly context-dependent: the same tool may be perceived positively in one course setup and negatively in another, depending on project design, available support, and the roles that models play (e.g., for communication versus strict code generation). They also find that perceptions of UML as modelling language are more positive and robust when models are used for requirements and analysis, rather than only as precise inputs to code generators \cite{liebel2014model}.
...
The literature on modelling education, Bloom-based frameworks, process and goal modelling, tooling, competencies, and human factors provides several important implications for this thesis. First, it suggests that modelling learning outcomes can be systematically described in terms of cognitive and knowledge dimensions, and that existing courses may underemphasise evaluation and metacognitive aspects of modelling competence \cite{bogdanova2020domain, bogdanova2020camelot, bork2020framework}. Second, it shows that different modelling families (e.g., data, process, goal) pose distinct learning challenges, and that empirical studies such as the iStar learning work can be used to derive grounded requirements for educational support \cite{istar-learning, bpmn-education}. Third, it highlights that tools and model-driven approaches can both enable and hinder learning, depending on how they are integrated into course designs and on the kind of feedback and affordances they provide \cite{liebel2014model,human-factors-mde}. Finally, competence-oriented and human-centred research indicates that modelling education must be sensitive to students' motivations, backgrounds, and learning environments, and that explicit competence models can support more systematic design and evaluation of teaching.
...
For this thesis, Bloom's revised taxonomy and its modelling-specific adaptations serve two main purposes. First, they offer a conceptual lens for thinking about modelling-related learning outcomes and competencies, distinguishing, for example, between understanding modelling constructs, applying modelling procedures, analysing and evaluating models, and reflecting on one’s own modelling practice. Second, the documented imbalances in current modelling education (e.g., underrepresentation of evaluation and metacognitive outcomes) motivate a closer examination of how students and teachers experience modelling and what kinds of support they perceive as needed \cite{bogdanova2020domain,bogdanova2020camelot,bork2020framework,sedelmaier2014research}.
