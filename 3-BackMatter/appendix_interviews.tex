...
This appendix provides the semi-structured interview guides used in the pilot phase and retained, with flexible probing, for the main corpus. The guides are designed to elicit: (i) perceived challenges across modelling activities (RQ1), (ii) coping strategies and articulated support needs (RQ2), and (iii) socio-technical shaping factors (RQ3). Questions are asked flexibly; probes are used selectively depending on time and participant responses.

Wave~2 student interviews (S7--S10) used the same student spine. Extra probes on start-gate, rework, feedback access, groups, cross-notation switching, and course load were used where they spoke to open questions from wave~1. They are a sampling aid, not a second protocol.
